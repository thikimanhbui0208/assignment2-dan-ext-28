...
def encrypt_file(shift1: int, shift2: int):
   ...
   for char in text:
       ...
       if 'a' <= char <= 'm':
           pos = ord(char) - ord('a') # Position within group (0-12)
       ...
       encrypted_text += new_char # Add all characters into the final encrypted text
...
# Decryption function: read the encrypted file, reverse the encryption, and write into a new file
def decrypt_file(shift1: int, shift2: int):
   ...
   for char in text:
       ...
       decrypted_text += new_char #  Add all characters into the final decrypted text
